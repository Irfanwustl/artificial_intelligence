...
class ExactInference(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        "*** YOUR CODE HERE ***" #Done - Old code + small modifications from the comments
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        """
        "*** YOUR CODE HERE ***" # Using the mode (%) to do even distribution: self.numParticles= 300, self.legalPositions = 216: First 216 are same then from 0 to 84 from self.legalPositions
